...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: PersonQueue.Enqueue() was adding items to the front instead of the back using Insert(0, person),
    // causing LIFO behavior instead of FIFO. This resulted in wrong dequeue order.
    ...
    // Defect(s) Found: None - the empty queue exception handling was implemented correctly.
